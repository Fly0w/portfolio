    ...
    render(){
        return(
            <div className='section contact'>
                <div className="group">
                    <h1 id="Contact" className="sectionTitle">Let's get in touch !</h1>
                    <div id="message">
                        <img className="drawing" src={drawing} alt="Cool drawing huh?"/>
                        <p> " I am looking forward to working on exciting new projects, and be part of a team that shares common values. Together, let's do our best ! "<br/><span>Florian Budniewski</span></p>
                    </div>
                </div>
